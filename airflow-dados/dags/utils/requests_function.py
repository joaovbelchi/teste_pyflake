...
def http_session(politica_retry: Retry = None) -> requests.Session:
    ...
    Returns:
        requests.Session: Objeto Session da lib requests.
    """

    if politica_retry is None:
        # Politica de retry padrão
    ...
    adapter = HTTPAdapter(max_retries=politica_retry)
